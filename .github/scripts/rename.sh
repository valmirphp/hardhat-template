...
# Rename instances of "valmirphp/hardhat-template" to the new repo name in README.md for badges only
sedi "/gitpod/ s|valmirphp/hardhat-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gitpod-badge/ s|valmirphp/hardhat-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gha/ s|valmirphp/hardhat-template|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gha-badge/ s|valmirphp/hardhat-template|"${GITHUB_REPOSITORY}"|;" "README.md"
